...
export const waitlistFormSchema = z.object({
  ...
  startupStage: z.string()
    .min(1, "Please select your startup stage"),
  ...
  howHeard: z.string().max(255, "How you heard about us must be less than 255 characters").optional(),
  lookingFor: z.string().max(255, "What you're looking for must be less than 255 characters").optional(),
  messageForUs: z.string().max(1000, "Message must be less than 1000 characters").optional(),
});
