      ...
      <div className='container mx-auto max-w-4xl'>
        <div className='flex h-14 items-center justify-between px-6 liquid-glass-header rounded-full'>
          ...
          <div className='hidden md:flex items-center gap-6'>
            ...
            >
              <Link
                href='https://chat.whatsapp.com/FqTkzzorqpNHavQLCKlj0c?mode=ems_wa_t'
                target='_blank'
          ...
          <div className='md:hidden'>
            <Sheet>
              ...
              <SheetContent
                side='right'
                className='bg-white border-gray-200 p-0 w-64 flex flex-col'
              >
                ...
                <div className='flex items-center gap-1.5 px-4 py-4 border-b border-gray-200'>
                  <span className='font-semibold tracking-wide text-gray-900 text-lg'>
                    NextIgnition
                  </span>
                </div>
