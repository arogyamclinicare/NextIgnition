        ...
        <div className='space-y-3 sm:space-y-4 pt-4 sm:pt-6 border-t border-gray-200'>
          ...
          >
            ...
            <textarea
              ...
              rows={3}
              className='w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all resize-none text-sm sm:text-base'
