  ...
  return (
    <div className='inline-block'>
      ...
      >
        {/* Bubble Layers */}
        <div
          className='absolute w-36 h-36 rounded-full blur-lg z-0 bg-pink-500 -top-5 -left-2'
          style={{
        ...
        />
        <div
          className='absolute w-36 h-36 rounded-full blur-lg z-0 bg-orange-500 top-0 left-2'
          style={{
        ...
        />
        <div
          className='absolute w-36 h-36 rounded-full blur-lg z-0 bg-yellow-400 top-5 left-1/2'
          style={{
        ...
        />
        <div
          className='absolute w-36 h-36 rounded-full blur-lg z-0 bg-cyan-400 -top-5 left-3/4'
          style={{
        ...
        />
        <div
          className='absolute w-36 h-36 rounded-full blur-lg z-0 bg-purple-600 top-7 -left-2'
          style={{
        ...
        />
        <div
          className='absolute w-36 h-36 rounded-full blur-lg z-0 bg-pink-500 -top-2 left-1/3'
          style={{
        ...
        />
        <div
          className='absolute w-36 h-36 rounded-full blur-lg z-0 bg-orange-500 top-10 left-3/5'
          style={{
