...
const faqData: FAQItem[] = [
  ...
  {
    question: "What makes NextIgnition different from LinkedIn or other platforms?",
    answer:
            ...
            {faqData.map((item, index) => (
              ...
              >
                ...
                >
                  ...
                  >
                    <p className="text-sm sm:text-base whitespace-pre-line">{item.answer}</p>
                  </AccordionPanel>
                </TimelineContent>
              </AccordionItem>
            ))}
        ...
        <div className="flex flex-col space-y-4 md:w-80 ml-auto">
          ...
          >
            ...
            <p className="text-sm sm:text-base text-black/90">
              Our purpose is to make startup success accessible and affordable for everyone,
              empowering entrepreneurs of all sizes to leverage the power of AI and networking to
              drive innovation, automate processes, and unlock new opportunities.
            </p>
          </TimelineContent>
          ...
          >
            ...
            <p className="text-sm sm:text-base text-black/90">
              Our mission is to connect the global startup ecosystem, making it easier for founders
              to find co-founders, mentors, investors, and AI-powered tools to turn their ideas into
              thriving businesses.
            </p>
          </TimelineContent>
        </div>
