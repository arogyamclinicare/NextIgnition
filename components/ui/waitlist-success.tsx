...
export function WaitlistSuccess({ onClose }: WaitlistSuccessProps) {
  ...
  const handleWhatsAppClick = () => {
    window.open(
      'https://chat.whatsapp.com/FqTkzzorqpNHavQLCKlj0c?mode=ems_wa_t',
      '_blank'
    );
  };
    ...
    <div ref={successRef} className='p-6 text-center'>
      ...
      >
        ...
        <p className='text-lg text-gray-700 leading-relaxed'>
          Thank you for joining our waitlist! You're now part of the
          NextIgnition community.
        </p>
      </TimelineContent>
      ...
      >
        <div className='bg-green-50 border border-green-200 rounded-xl p-6'>
          ...
          <p className='text-gray-700 mb-4'>
            Connect with fellow entrepreneurs, get early access to features, and
            be part of our growing startup ecosystem.
          </p>
          <motion.button
